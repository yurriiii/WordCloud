...
const databaseURL = "https://word-cloud-83861.firebaseio.com"
...
class Texts extends React.Component {
    ...
    handleFileChange = (e) => {
        ...
        reader.readAsText(e.target.files[0], "EUC_KR");
        this.setState({
        ...
        return (
            <div>
                ...
                <Dialog open={this.state.dialog} onClose={this.handleDialogToggle}>
                    ...
                    <DialogContent>
                        <TextField label="텍스트 이름" name="textName" value={this.state.textName} onChange={this.handleValueChange}/><br></br>
